# Welcome CuongDNSE130489 from Using Python to Access Web Data
#
...
# Actual data: http://py4e-data.dr-chuck.net/comments_1032794.xml (Sum ends with 47)
...
# # To make the code a little simpler, you can use an XPath selector string to look through the entire tree of XML for any tag named
...
url = input("enter url: ")
dataXml = urllib.request.urlopen(url, context=ctx).read()
...
sum = 0
for items in list:
    countTemp = int(items.find('count').text)
    sum += countTemp
