...
# You can test to see if your program
#  is working with a location of "South Federal University" which will have a place_id of "ChIJJ2MNmPl_bIcRt8t5x-X5ZhQ".
# $ python3 solution.py
...
# Hint: The first seven characters of the place_id are "ChIJG_N ..."
